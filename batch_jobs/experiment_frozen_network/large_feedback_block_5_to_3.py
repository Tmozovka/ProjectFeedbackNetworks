...
from src.models.FeedbackModelBuilder import VGG16FeedbackFrozen5BlockTo3Block
from training_procedure import run_training

path_to_datasets = '../../../../experiments/create_datasets/normalize_dataset/saved_datasets/'
models = [VGG16FeedbackFrozen5BlockTo3Block, ]
model_names = ["Feedback_5block_to_3block", ]

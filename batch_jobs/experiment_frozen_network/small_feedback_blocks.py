...
from src.models.FeedbackModelBuilder import VGG16FeedbackFrozen4BlockTo4Block, VGG16FeedbackFrozen5BlockTo5Block, VGG16FeedbackFrozen5BlockTo4Block
...
models = [VGG16FeedbackFrozen5BlockTo5Block, VGG16FeedbackFrozen5BlockTo4Block]
model_names = ["Feedback_5block_to_5block", "Feedback_5block_to_4block"]

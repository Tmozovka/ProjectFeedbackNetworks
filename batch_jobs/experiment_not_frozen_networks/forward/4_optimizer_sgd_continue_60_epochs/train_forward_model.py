...
class FeedforwardModelFrozen(keras.Model):
  def __init__(self, **kwargs):
    super(FeedforwardModelFrozen, self).__init__(name="FFmodel", **kwargs)
...
if __name__ == "__main__":
    ...
    checkpoint_filepath_frozen = '../1_train_10_epochs_frozen/tmp/checkpoint'
    ...
    with strategy.scope():
        ...
        model_frozen = FeedforwardModelFrozen()

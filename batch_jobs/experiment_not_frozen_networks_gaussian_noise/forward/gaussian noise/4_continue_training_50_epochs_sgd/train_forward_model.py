...
if __name__ == "__main__":
    ...
    checkpoint_filepath_before = '../3_continue_training_sgd_20_optimizer/tmp/checkpoint'
    ...
    with strategy.scope():
        ...
        model.load_weights(checkpoint_filepath_before)
    ...
    for v in ["test loss", results[0], "test acc", results[1], \
             "test loss_gaussian_noise", results_gaussian_noise[0], "test acc_gaussian_noise", results_gaussian_noise[1], \
             "test loss_salt_pepper_noise", results_salt_pepper_noise[0], "test acc_salt_pepper_noise", results_salt_pepper_noise[1]]:

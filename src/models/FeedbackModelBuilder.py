...
class VGG16FeedbackFrozen5BlockTo3Block2ProjLayers(keras.Model):
    def __init__(self, **kwargs):
        super(VGG16FeedbackFrozen5BlockTo3Block2ProjLayers, self).__init__(name="FFmodel", **kwargs)
        VGG = VGG16(weights='imagenet', include_top=False)
        self.VGG_before_feedback = keras.Model(VGG.input, VGG.layers[-13].output)
        self.VGG_before_feedback.trainable = False
        ...
        self.project_conv1 = Conv2D(128, kernel_size=(3,3), padding= 'same', activation= 'relu')
        self.project_conv2 = Conv2D(128, kernel_size=(3,3), padding= 'same', activation= 'relu')
...
class VGG16FeedbackFrozen5BlockTo3Block3ProjLayers(keras.Model):
    def __init__(self, **kwargs):
        super(VGG16FeedbackFrozen5BlockTo3Block3ProjLayers, self).__init__(name="FFmodel", **kwargs)
        VGG = VGG16(weights='imagenet', include_top=False)
        self.VGG_before_feedback = keras.Model(VGG.input, VGG.layers[-13].output)
        self.VGG_before_feedback.trainable = False
        ...
        self.project_conv1 = Conv2D(128, kernel_size=(3,3), padding= 'same', activation= 'relu')
        self.project_conv2 = Conv2D(128, kernel_size=(3,3), padding= 'same', activation= 'relu')
        self.project_conv3 = Conv2D(128, kernel_size=(3,3), padding= 'same', activation= 'relu')
